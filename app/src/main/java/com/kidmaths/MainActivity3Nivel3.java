...
public class MainActivity3Nivel3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity3_nivel3);
    ...
    public  void NumAleatorio(){
        if(score <= 29 ){
            ...
            Intent intent = new Intent(this,MainActivity4Nivel4.class);

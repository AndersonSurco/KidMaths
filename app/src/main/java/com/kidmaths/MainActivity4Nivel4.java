...
public class MainActivity4Nivel4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity4_nivel4);
    ...
    public  void NumAleatorio(){
        if(score <= 39 ){
            ...
            signoaAleatorio = (int) (Math.random() * 2);
            ...
            Intent intent = new Intent(this,MainActivity5Nivel5.class);

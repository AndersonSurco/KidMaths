...
public class MainActivity5Nivel5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity5_nivel5);

        Toast.makeText(this,"Nivel 5", Toast.LENGTH_SHORT).show();
    ...
    public  void NumAleatorio(){
        if(score <= 49 ){
            ...
            Intent intent = new Intent(this,MainActivity6Nivel6.class);
